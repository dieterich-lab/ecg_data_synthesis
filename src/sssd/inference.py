...
def generate(output_directory,
    ...
    filename_test_labels = os.path.join(here, 'ptbxl_test_labels.npy')
    labels = np.load(filename_test_labels)  # shape - (2203, 71)
    l1 = labels[0:400]
    l2 = labels[400:800]
    l3 = labels[800:1200]
    l4 = labels[1200:1600]
    ...
    for i, label in enumerate((l1, l2, l3, l4, l5, l6)):
        ...
        generated_audio = sampling_label(net, (label.shape[0], 8, trainset_config["segment_length"]),
        ...
        print('saved the conditioned labels at iteration %s' % ckpt_iter)
